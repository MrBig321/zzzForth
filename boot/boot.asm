...
;************************************************;
ReadSectors:
.MAIN		mov di, 0x0005							; five retries for error
.SECTORLOOP	push ax
			push bx
			push cx
			...
			int 0x13								; invoke BIOS ;AH: statuscode, CF is clear if success
...
LOAD_FAT:
	...
	; read image file into memory (0900:0000)
...
.DONE:		mov WORD [cluster], dx					; store new cluster
